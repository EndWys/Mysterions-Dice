...
public class Second_dice : MonoBehaviour
{
    public Camera cam;
    Transform dice;
    ...
    private void Start()
    {
        dice = GameObject.Find("Dice_2").transform;
    ...
    void Roll(Transform Dice_target)
    {
        ...
        Dice_sprite.sprite = Dice_sprites.dices[2 + side];
    ...
    IEnumerator Rolling(float timer)
    {
        ...
        else
        {
            ...
            if (Dice_sprites.dices[2 + i] != null)
                Dice_sprite.sprite = Dice_sprites.dices[2 + i];
